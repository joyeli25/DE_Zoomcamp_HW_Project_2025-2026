...
select z."Zone", sum(total_amount)
 ...
 inner join taxi_zone_lookup z on t."PULocationID"=z."LocationID"
...
select z2."Zone", max(tip_amount)
 from green_taxi_data t
 inner join taxi_zone_lookup z1 on t."PULocationID"=z1."LocationID"
 inner join taxi_zone_lookup z2 on t."DOLocationID"=z2."LocationID"
 where lpep_pickup_datetime>='2025-11-01'
 and lpep_pickup_datetime<'2025-12-01'
